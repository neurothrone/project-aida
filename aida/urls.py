...
urlpatterns = [
    ...
    # region Activity
    # Workout
    path("workout/list/", workout.crud.List.as_view(), name="workout-list"),
    path("workout/create/", workout.crud.Create.as_view(), name="workout-create"),
    path("workout/detail/<int:pk>/", workout.crud.Detail.as_view(), name="workout-detail"),
    path("workout/update/<int:pk>/", workout.crud.Update.as_view(), name="workout-update"),
    path("workout/delete/<int:pk>/", workout.crud.Delete.as_view(), name="workout-delete"),
